...
\begin{abstract}
We study complexity of deep computations. We use topology of function spaces, specifically, the classification Rosenthal compacta, to identify new complexity classes.  We use the language of model theory, specifically,  the concept of  the independence from Shelah's classification theory,  to translate between topology and computation. We study approximablility of deep computations, both deterministically and probabilistically.
\end{abstract}
