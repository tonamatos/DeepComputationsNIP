...
\begin{abstract}
We use topological methods to study complexity of deep computations and limit computations. We use topology of function spaces, specifically, the classification Rosenthal compacta, to identify new complexity classes.  We use the language of model theory, specifically,  the concept of  the independence from Shelah's classification theory,  to translate between topology and computation. We use the theory of Rosenthal compacta to characterize approximablility of deep computations, both deterministically and probabilistically.
\end{abstract}
