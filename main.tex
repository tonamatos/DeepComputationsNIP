...
The Independence Property was first isolated by Saharon Shelah in model theory as a dividing line between theories whose models are analyzable, or ``tame'' (corresponding to NIP) theories of models are ``unclassifiable" or ``wild" ((corresponding to IP). See~\cite{Shelah:1971,Shelah:1990}.
