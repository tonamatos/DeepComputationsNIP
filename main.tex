...
The countability assumption on $\mathcal{P}$  played a crucial  role in the proof of Theorem \ref{Generalized BFT} essentially because it makes $\mathbb{R}^\mathcal{P}$ a Polish space. In this section, we do not assume that $\mathcal{P}$ is countable.  We replace deterministic computability by measure-theoretic (`Monte Carlo') computability.
