...
📄 **[View latest compiled PDF](https://tonamatos.github.io/DeepComputationsNIP/)**

## License and Usage

© 2025 Eduardo Dueñez, José Iovino, [Tonatiuh Matos-Wiederhold](https://www.wiederhold.dev/), Luciano Salvetti, and Franklin D. Tall.

This repository contains the LaTeX source files for the paper _Complexity of Deep Computations via Topology of Function Spaces_, currently in preparation. It also contains the script `tools/render_newton.py` to make the diagrams, stored in `images/`, used in the paper.
