...
For any fixed length $n\in \mathbb{N}$, finite binary strings $y\in 2^n$ will be implicitly identified with their zero-extension to sequences $\iota(y) = (x_i)_{i\in \mathbb{N}} \in 2^{\mathbb{N}}$, namely
\begin{equation*}
  x_i
  =
  \begin{cases}
