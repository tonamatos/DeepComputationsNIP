...
The finer result of this paper is obtained through more sophisticated topological and model-theoretic tools than in the previous paper~\cite{alva2024approximability}. 
...
The main tool of neostability id Shelah's \emph{Independence Property}, or rather, its negation, referred to as NIP. 
More on this below.
...
We apply a result of Bourgain, Fremlin and Talagrand from the late 70s on compact subsets of the first Baire class to obtain a new ``tame vs wild'' dichotomy for  deep computations; 
then, we apply a trichotomy of Todorčević, from the late 90s, for \emph{Rosental compacta}~\cite{Todorcevic_1999_CompactSubsetsBaire} to identify new tame classes.

Rosenthal compacta are defined as compact spaces that are homeomorphic to subspaces of the space of Baire class~1 functions on some Polish (separable, completely metrizable) space, under the topology of pointwise convergence.
