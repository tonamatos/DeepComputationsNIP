...
In the measure-theoretic side, we have identified two levels of PAC-learnability: Talagrand stability with respect to any measure and the NIP, which can also be desci. The natural question is whether these two classes are the same. Even in the simple case of countably many computations, we hit an undecidability phenomenon by assuming that computations are
