...
We obtain a new ``tame vs wild'' Ramsey-theoretic dichotomy for  deep computations
...
Todorčević’s trichotomy concerns \emph{Rosenthal compacta}; these are topological spaces that fit our applications perfectly:
they are compact spaces that can be embedded (homeomorphically identified as a subset) within the space of Baire class~1 functions on some Polish (separable, completely metrizable) space, under the topology of pointwise convergence.
