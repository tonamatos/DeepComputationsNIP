...
Taking the topological closure of the set of mappings $\Gamma=\{\gamma^k_p:k\in\mathbb N\}$ adds but a single new map given by the pointwise limit of the sequence. In symbols, $\overline\Gamma=\Gamma\cup\{\gamma\}$, which is metrizable,


\begin{figure}[h]\label{fig:newton}
