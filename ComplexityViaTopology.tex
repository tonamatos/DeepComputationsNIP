...
There is an \emph{approximating function} $\varphi_{Q,\,K,\varepsilon}: L\to \mathcal{R}$ that can be built recursively out of a finite number of the (primitively computable) predicates in $\mathcal{P}$
