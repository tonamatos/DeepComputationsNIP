...
We are interested in families of real-valued functions that are pointwise bounded. This leads us to the concepts of \emph{sizer} and \emph{shard} introduced first in introduced in~\cite{alva2024approximability}:
