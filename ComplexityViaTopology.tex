...
We expect to extend most of them to $K$-countably determined (Lindelöf $\Sigma$) spaces or  $K$-analytic spaces, which have previously been used in functional analysis --- see e.g., Kakol et al~\cite{Kakol-Kubis-Lopez-Pelicer:2011}. 
...
We have hinted at applications to deep equilibria; this is also work in progress. 
...
However, one must be careful, since many of our techniques involve infinite sets so we have to check that our assertions are sufficiently simple so as to be absolute, i.e. unaffected by additional axioms. 
