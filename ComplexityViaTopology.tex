...
That is, there exists a finite $\mathcal{P}'\subseteq\mathcal{P}$ such that $V=\bigcap_{P\in\mathcal{P}'}\pi_P^{-1}[U_P]$ where, for each $P\in \mathcal{P}'$, the set $U_P\subseteq \mathbb{R}$ is open.
Then, 
