...
Simplest among deep computations are those arising as pointwise limits of (continuous) computations.
...
\begin{proof}
  ...
  For any $I, J\subseteq \mathbb{N}$ (almost disjoint in applications), write $X_{I,J}$ for $X^{f_I}_{\le r}\cap X^{f_J}_{\ge s}$.
