...
\begin{rem}
This is a remark for readers versed in model theory. Computation states structures are real-valued structures (see \cite[section 6]{Duenez-Iovino:2017} for a tutorial; 
see also~\cite{Keisler:2023}), and the class of computation state structures is closed under ultraproducts and ultrapowers. 
