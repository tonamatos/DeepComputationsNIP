...
However, as the next example shows, it can be made separable space by ``widening' the neighborhoods through the addition of a countable set.
...
As with the Alexandroff compactification $A(2^{\mathbb{N}})$, we can make the space $D(2^{\mathbb{N}})$ separable  by ``widening' the neighborhoods through the addition of a countable set.
