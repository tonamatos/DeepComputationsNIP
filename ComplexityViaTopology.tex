...
The finer results of this paper are obtained through more contemporary topological and model-theoretic tools than in the previous paper~\cite{alva2024approximability}. 
...
The main neostability tool of  is Shelah's \emph{Independence Property}, or rather, its negation, referred to as NIP. 
More on this below.
...
Rosenthal compacta are defined as compact topological spaces that are homeomorphic to subspaces of the space of Baire class~1 functions on some Polish (separable, completely metrizable) space, under the topology of pointwise convergence.
