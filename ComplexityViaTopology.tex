...
Todorčević’s trichotomy concerns \emph{Rosenthal compacta}; these are topological spaces defined as compact spaces that can be embedded (homeomorphically identified as a subset) within the space of Baire class~1 functions on some Polish (separable, completely metrizable) space, under the topology of pointwise convergence.
