...
\begin{proof}
    ...
    Define an extension  $\tilde{f}:\mathcal{L}_{\sh}\rightarrow \mathcal{L}_{\sh}$ by $\tilde{f}:=\mathcal{U}\lim_i\tilde{\gamma_i}$.
    Since $\Delta$ is $R$-confined we have $f:L[r_\bullet]\rightarrow L[r_\bullet]$ and $\tilde{f}:\mathcal{L}[r_\bullet]\rightarrow \mathcal{L}[r_\bullet]$ for all $r_\bullet\in R$.
