...
When these relations are regarded as elements of $B_1(2^{\mathbb{N}})$, we will denote  ${\preceq}x$ by $\bar{x}$, and ${\prec}x$ by~$\hat{x}$.

\paragraph{Split Cantor}
Per the preceding discussion, threshold classifiers constitute a set
\begin{equation*}
...
$\mathrm{Cl}(\widehat{C}) = \cancel{C}\setminus\{1_{\bullet}\}$ and $\mathrm{Cl}(\overline{C}) = \cancel{C}\setminus\{0_{\bullet}\}$.
