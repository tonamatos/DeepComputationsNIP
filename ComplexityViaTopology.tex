...
The set $2^n$ of finite binary strings (“words”) $w$ of any fixed length $|w| = n$ will be implicitly identified with a subset of~$2^{\mathbb{N}}$ by identifying $w$ with its zero extension $\iota(w) = (x_i)_{i\in \mathbb{N}} \in 2^{\mathbb{N}}$, namely
\begin{equation*}
  x_i
  =
  \begin{cases}
