...
However, as the next example shows, it can be ``softened''  to make it separable space through the addition of a countable set.
...
As with the Alexandroff compactification $A(2^{\mathbb{N}})$, we can make the space $D(2^{\mathbb{N}})$ separable ``softening''  it through the addition of a countable set.
