...
One elementary fact about Baire class~1 functions is that they are continuous except on a set of first category: also called a \emph{meager} set, a set of first cateogory is the countable union of sets whose closure has empty interior; intuitively, these sets are ``topologically small.''
