...
The following lemma will be instrumental to prove of proposition~\ref{prop:Talagrand implies NIP}, which, in turn, will yield Theorem~\ref{T:Talagrand stability and Monte Carlo}, our main result on Talagrand stability.
...
\begin{proof}
    This is a direct consequence of proposition \ref{prop:Talagrand implies NIP} and Theorem 4.8.
\end{proof}

In the measure-theoretic context, we have identified two notions of PAC-learnability, namely, 
NIP and Talagrand stability. 
