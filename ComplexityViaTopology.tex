...
From a computational viewpoint, since machines have finite memory, the set of inputs and outputs of any individual computations must be bounded; however, the bounds may depend on the feature of the computation.
