...
The \emph{raison d'être} of the Baire class-1 functions is to work with a class of functions that are obtained as limit points of continuous functions (deep computations) but are not too far from being continuous.
