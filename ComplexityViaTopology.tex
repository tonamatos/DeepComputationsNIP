...
The finer result of this paper is obtained through more sophisticated topology and model theory than in the previous paper~\cite{alva2024approximability}. 
...
then, we apply a trichotomy of Todorčević, from the late 90s, for functions of the first Baire class~\cite{Todorcevic_1999_CompactSubsetsBaire} to identify new tame classes.

Todorčević’s trichotomy concerns \emph{Rosenthal compacta};
these are defined as compact spaces that are homeomorphic to subspaces of the space of Baire class~1 functions on some Polish (separable, completely metrizable) space, under the topology of pointwise convergence.
