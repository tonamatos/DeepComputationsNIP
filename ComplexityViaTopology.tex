...
In this manner, we obtain the \emph{Cantor-prefixing CCS}
\begin{equation*}
...
This gives the \emph{Bernoulli-Cantor CCS}
\begin{equation*}
...
(i.e., the symbol “${\preccurlyeq}_nw$” names a unary relation taking its argument $x$ on the left).
