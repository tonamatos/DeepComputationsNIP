...
Regard $\mathcal{P}$ as a discrete topological space.
Let $\left(\mathbb{R}^\mathcal{P}\right)^X\to\mathbb{R}^{\mathcal{P}\times X}: f\mapsto\hat{f}$ be the natural homeomorphism (of topological products), and $\mathbb{R}^{\mathcal{P}\times X}\to\left(\mathbb{R}^\mathcal{P}\right)^X: g\mapsto \check{g}$ its inverse.
...
\begin{proof}
  ...
  evidently, $\psi_n\in C_p(X, R^{\mathcal{P}})$ because $f^P_n\in C_p(X)$ by construction, and moreover $\pi_P\circ\psi_n = f^P_n$ converges to $\varphi^P = \pi_P\circ\varphi$ for each $P\in \mathcal{P}$ as $n\rightarrow\infty$, hence $\{\psi_n\}$ converges to~$\varphi$ pointwise, so $\varphi\in B_1(X, \mathbb{R}^{\mathcal{P}})$.
\end{proof}
...
\subsection{Finite precision threshold classifiers}
