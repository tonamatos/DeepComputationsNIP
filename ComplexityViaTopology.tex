...
In this paper we  study asymptotic behavior of computations as parameters of the computation change, e.g., the depth of a neural network tending to infinity, or the time interval between layers of a time-series network tending toward zero.
