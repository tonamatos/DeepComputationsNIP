...
The main topological result that allows us to attain this new classification is Todorčević's remarkable trichotomy~\cite{Todorcevic_1999_CompactSubsetsBaire}. 
Our inspiration for this is the work of Glasner and Megrelishvili on topological dynamics~\cite{glasner2022tame}.
In subsection~\ref{S:trichotomy}, we study the implications of Todorčević's  trichotomy in the context of deep computations;
...
Since our interest is in applications to  the theory of computation, we focus on countable sets of computations, and in compositional computational structures where the set $\mathcal{P}$ of predicates is countable.
In this section,


The following theorem is the cornerstone of the section, as it established the main link between deep computations and Rosenthal compacta; it states that, under the assumption that $\mathcal{P}$ is countable, 
the space of deep computations is a Rosenthal compactum (when restricted to shards) if and only if the set of computations satisfies the NIP feature by feature.
