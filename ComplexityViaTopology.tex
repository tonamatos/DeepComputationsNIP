...
Let $K$ be any compact metric space, and consider the Polish space $X=K\sqcup C(K)$, i.e., the disjoint union of $K$ and $C(K)$ (the space of real-valued continuous functions on $K$ with the supremum norm topology) and $K$.
