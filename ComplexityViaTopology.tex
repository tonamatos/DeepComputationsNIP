...
In this paper, we apply the theory of spaces of Baire class~1 functions to identify and separate new complexity classes of deep computaitons.
...
as well as a new trichotomy for the class of ``tame'' deep computations by invoking an equally celebrated result of Todorčević, from the late 90s, for functions of the first Baire class~\cite{Todorcevic_1999_CompactSubsetsBaire}.
