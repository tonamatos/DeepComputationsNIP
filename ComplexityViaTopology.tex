...
The main result of the paper is the identification of a hierarchy of four distinct complexity classes for limit computations, and seven minimal prototypes. 
This is obtained by invoking results from topology of spaces of functions.
Specifically, we apply Todorčević’s trichotomy for function spaces~\cite{Todorcevic_1999_CompactSubsetsBaire} and the Argyros-Dodos-Kanellopoulos heptachotomy~\cite{argyros2008rosenthal},
both of which pertain to topology of function spaces,  into the realm of computation.
