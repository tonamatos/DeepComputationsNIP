...
in the values of the predicates $P_i(w)$ for $i<n$
(i.e., $\phi_w$ may be expressed in terms of the values $P_i(w)$ using the operations of maximum, minimum and negation $\neg: r\mapsto 1-r$ in place of classical Boolean connectives).

\subsubsection{Infinite precision classifiers}
