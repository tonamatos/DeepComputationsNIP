...
In this section, we replace deterministic computability by measure-theoretic (`Monte Carlo') computability.
...
The following measure-theoretic characterization of the NIP will lead us to find other connections between topology of function spaces and Monte Carlo computability (see the next section):
