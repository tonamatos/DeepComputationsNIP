...
%The following lemma shows that, just as in the case of  NIP, Talagrand $\mu$-stability is directly related to relative compactness in the space $\mathscr{M}^0(X,\mu)$.
The following lemma will be instrumental to prove of Proposition~\ref{prop:Talagrand implies NIP}, which, in turn, will yield our main result on Talagrand stability, Theorem~\ref{T:Talagrand stability and Monte Carlo}.
...
\begin{cor}
\label{T:Talagrand stability and Monte Carlo}xx
    Let $(L,\mathcal{P},\Gamma)$ be a CCS satisfying the Extendibility Axiom.
