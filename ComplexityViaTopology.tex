...
\begin{enumerate}
\item
Littlewoood's second principle states that every Lebesgue measurable function is ``nearly continuous''. The formal statement of this, which is Luzin's theorem, is that if
...
\begin{proof}
    The equivalence (i)-(iii) is Theorem \ref{BFT-2F}, ans the equivalence of (iii) and (iv) is Fremlin's Dichotomy (Theorem~\ref{T:Fremlins dichotomy}).
\end{proof}
