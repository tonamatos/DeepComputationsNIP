...
If $X$ is a compact (Hausdorff) space, then Radon measures on $X$ are finite, and hence, they can be normalized to probability measures.
We record this as a remark:
...
\begin{rem}
    Every Radon measure on a compact space (e.g., $\mathcal{L}_{\sh}$) is finite; hence, by proper normalization, it can be treated as a probability measure.
