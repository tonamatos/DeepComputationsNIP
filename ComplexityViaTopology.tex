...
%Topologically, we expect to extend some of our results  to $K$-countably determined (Lindelöf $\Sigma$) spaces or  $K$-analytic spaces, which have previously been used in functional analysis --- see e.g., Kakol \emph{et al}~\cite{Kakol-Kubis-Lopez-Pellicer-Sobota:2025}.
