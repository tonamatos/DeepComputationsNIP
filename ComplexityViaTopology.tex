...
We use topology of function spaces to obtain a new classification for the complexity of deep computations.
The main topological result  is Todorčević's remarkable trichotomy for Rosenthal's compacta~\cite{Todorcevic_1999_CompactSubsetsBaire}. 
Our inspiration for this is the work of Glasner and Megrelishvili on tame semigropus in topological dynamics~\cite{glasner2022tame}.
...
Furthermore, it shows that every deep computation generated by $\Delta$ is a sequential limit (rather than an abstract ultrafilter limit) of computations in $\Delta$.
...
However, as the next example shows, it can be converted into a separable space by adding a countable set to it, 
