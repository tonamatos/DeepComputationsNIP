...
The closure of $\{p_n\}$ in $\{0, 1\}^X$ (or in $\mathbb{R}^{X}$ for that matter) is homeomorphic to the \emph{Stone-Čech compactification $\beta\mathbb{N}$} of the discrete space of natural numbers which is an important object of study in general topology.
