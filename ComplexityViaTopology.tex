...
As we move from $C_p(X)$ to the larger space $B_1(X)$, we find a similar dichotomy:
...
Such theorem is usually not phrased as a dichotomy, but rather as an equivalence:
