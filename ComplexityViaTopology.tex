...
The main result of this section is that accumulation points of standard computations  (i.e., deep computations) are Monte Carlo computable (Theorem~\ref{T:Talagrand stability and Monte Carlo}).
